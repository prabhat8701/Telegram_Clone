...
import { messagesData } from "../data/Telegram";
import { MdSearch, MdSend } from "react-icons/md";
import { HiDotsVertical } from "react-icons/hi";
import { BiHappy } from "react-icons/bi";
import { AiOutlinePaperClip } from "react-icons/ai";
import { BsFillMicFill } from "react-icons/bs";
import { cs1, cs2 } from "../assets/Telegram";
import { getTime } from "../logic/Telegram";
...
function ChatDetail() {
  ...
  return (
    ...
    <div className="flex flex-col h-screen">
      {/* Contact nav */}
      <div className="flex justify-between bg-[dark] h-[60px] p-3">
        {/* Contact info */}
        <div className="flex items-center">
          ...
          <div className="flex flex-col">
            {/* Contact */}
            <h1 className="text-white font-medium">Titan</h1>
      ...
      {/* Bottom section */}
      <div className="flex items-center bg-[dark] w-100 h-[70px] p-2" >
        {/* Emoji btn */}
        ...
        <input 
          ...
          className="bg-[white] rounded-lg outline-none text-sm text-neutral-200 w-100 h-100 px-3 placeholder:text-sm placeholder:text-[#8796a1]"
